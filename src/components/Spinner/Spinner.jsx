  ...
  return (
    <div className="spinner">
      <svg className="book-shelf" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
        ...
        />
        <g className="book__book book__book--one" fillRule="evenodd">
          <path
            fill="#5199fc"
        ...
        <g className="book__book book__book--two" fillRule="evenodd">
          <path
            fill="#ff9868"
        ...
        <g className="book__book book__book--three" fillRule="evenodd">
          <path
            fill="#ff5068"
